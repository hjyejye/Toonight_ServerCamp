package com.example.toonight.service;


import com.example.toonight.domain.Role;
import com.example.toonight.domain.entity.MemberEntity;
import com.example.toonight.domain.repository.MemberRepository;
...
public class MemberService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String userEmail) throws UsernameNotFoundException {
        ...
        if (("libee1212@google.com").equals(userEmail)) {
